...
def draw_uniform_distribution_graphs(
    ...
    while x <= x_max:
        uniform_distribution_list.append(uniform_distribution.f_distribution(x))
        uniform_distribution_density_list.append(uniform_distribution.f_distribution_density(x))
        x_list.append(x)
        x += step
